...
export const skillsData: Skill[] = [
	// Frontend Skills
	{
		...
		name: "Unity",
		description:
			"A cross-platform game engine for creating 2D and 3D games.",
		icon: "devicon:unity",
		category: "frontend",
		level: "intermediate",
		experience: { years: 2, months: 3 },
		projects: ["Unity CycleList Component", "Game Development"],
		color: "#49f106",
	},
	{
		id: "javascript",
	...
	// },
	{
		...
		name: "Lua",
		description:
			"A lightweight scripting language widely used in game development and embedded systems.",
		icon: "logos:lua",
		category: "backend",
		level: "advanced",
