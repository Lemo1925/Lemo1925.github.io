...
export const siteConfig: SiteConfig = {
	title: "Lemo",
	subtitle: "website",
	siteURL: "https://lemo1925.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-03-22", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "lemo", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "5631380", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Lemo1925",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/5631380",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/Lemo1925",
					external: true,
					icon: "mdi:git",
				},
			],
